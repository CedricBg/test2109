...
INSERT INTO Roles (DiminName, Name, Numero) Values('SB'    , 'Agent statique' ,1)
INSERT INTO Roles (DiminName, Name, Numero) Values('SQ'    , 'Agent statique qualifié',2 )
INSERT INTO Roles (DiminName, Name, Numero) Values('SE'    , 'Agent statique expert' ,3)
INSERT INTO Roles (DiminName, Name, Numero) Values('SEL'   , 'Agent statique expert langues',4 )
INSERT INTO Roles (DiminName, Name, Numero) Values('SBG'   , 'Agent statique bodyguard',5 )
INSERT INTO Roles (DiminName, Name, Numero) Values('MB'    , 'Agent statique base militaire',6 )
INSERT INTO Roles (DiminName, Name, Numero) Values('SMBP'  , 'Portier',7 )
INSERT INTO Roles (DiminName, Name, Numero) Values('MBB'   , 'Brigadier',8 )
INSERT INTO Roles (DiminName, Name, Numero) Values('M1'    , 'Agent mobile patrouille',9 )
INSERT INTO Roles (DiminName, Name, Numero) Values('M2'    , 'Agent mobile IAA et chauffeur VIP',10 )
INSERT INTO Roles (DiminName, Name, Numero) Values('TR'    , 'Transporteur de fonds/agent ATM',11 )
INSERT INTO Roles (DiminName, Name, Numero) Values('PRVA'  , 'Collaborateur vault /processing',12 )
INSERT INTO Roles (DiminName, Name, Numero) Values('BI'    , 'Brigadier/instructeur',13 )
INSERT INTO Roles (DiminName, Name, Numero) Values('TM'    , 'Transport de munitions',14 )
INSERT INTO Roles (DiminName, Name, Numero) Values('GDM'     , 'Homme de métier',15 )
INSERT INTO Roles (DiminName, Name, Numero) Values('DIR'   , 'Direction',50 )
INSERT INTO Roles (DiminName, Name, Numero) Values('OPS'    , 'Opérations',51 )
INSERT INTO Roles (DiminName, Name, Numero) Values('ADM'   , 'Administratif',52 )
INSERT INTO Roles (DiminName, Name, Numero) Values('AGENT' , 'Accès minimum',53 )
INSERT INTO Roles (DiminName, Name, Numero) Values('SUB'   , 'Sous-traitant',54 )
INSERT INTO Roles (DiminName, Name, Numero) Values('CUST'  , 'Client',55 )
...
INSERT INTO Users ([Login],Password_hash ,Salt) Values('ced', 0x2A36877DE9A35F9F8E7789DCACAAD10FA41CEB678A818F03634C0446D317AB0C,'3074B05A-7124-4B92-A1FD-6CE30A222594686BF7B5-323A-47EF-9FC2-FCD4B5E05133409049B7-6C86-4249-84EC-78BA')
